...
class SnmpClientRequestAggregatorTest {
    ...
    void requestWithGetOperationResponseShouldAddToResult() throws Exception {
        ...
        try (SnmpClientRequestAggregator aggregator = createAggregator()) {
            ...
            request.getResultAsync(resultRef::set);
        }
    ...
    @Test
    void requestWithWalkOperationResponseShouldAddToResult() {
        final OID oid = new OID("1");
    ...
    @Test
    void requestWithTableOperationResponseShouldAddToResult() {
        final String tableName = "fooBarTable";
    ...
    void requestWithMultipleOperationsShouldAggregateResults() throws IOException {
    ...
    @Test
    void requestWithMultipleOperationsShouldAggregateResultsEvenIfOneFail() throws IOException {
        when(snmpClient.get(COMMUNIT_TARGET, SOME_OIDS))
