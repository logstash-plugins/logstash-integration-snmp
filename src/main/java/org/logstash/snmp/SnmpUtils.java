...
final class SnmpUtils {
    ...
    static OID parsePrivProtocol(String privProtocol) {
        ...
        switch (privProtocol) {
            ...
            case "aes256with3desExt":
                return SnmpConstants.oosnmpUsmAesCfb256ProtocolWith3DESKeyExtension;
            default:
                throw new SnmpClientException(String.format("privacy protocol '%s' is not supported, expected protocols are 'des', '3des', 'aes', 'aes128', 'aes192', 'aes256' and 'aes256with3desExt'", privProtocol));
        }
    }
