...
Earlier (1.x) versions of the `input-snmp` plugin that were bundled with {ls} by default will be replaced by the 4.0.0+ version contained in this new integration.
